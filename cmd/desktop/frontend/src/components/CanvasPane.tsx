...
interface CanvasNode {
  ...
  sessionId: string;
  minimized: boolean;
  // File-backed preview: watches ~/.pi-go/canvas/{htmlFile}.html and auto-refreshes
  htmlFile?: string;
}
    ...
    <div className="relative w-full h-full overflow-hidden bg-[rgb(22,22,20)] select-none">
      ...
      <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2
        ...
        <button
          ...
          title="Bind a cell to ~/.pi-go/canvas/<name>.html — auto-refreshes when file changes">
          + File Cell
        </button>
        ...
        <div className="absolute inset-0 z-[200] flex items-center justify-center bg-black/40"
          ...
          <div className="bg-[rgb(34,34,32)] border border-[rgba(255,255,255,0.12)] rounded-2xl p-5 w-80 shadow-2xl"
            ...
            <p className="text-[11px] text-[rgba(255,255,255,0.4)] mb-3">
              Watches <code className="text-purple-400">~/.pi-go/canvas/<em>name</em>.html</code><br />
                      ...
                      {node.htmlFile ? (
                        <>
                          ...
                          <p className="text-[12px] text-[rgba(255,255,255,0.35)]">
                            Waiting for <code className="text-purple-400">~/.pi-go/canvas/{node.htmlFile}.html</code>
                          </p>
