...
详见 → `cover-gen/SKILL.md`

| 子步骤 | 说明 |
|--------|------|
| 提取关键帧 | ffprobe 获取分辨率/fps，ffmpeg 截取参考帧 |
| 确定平台规格 | 抖音 3:4 / B站 16:9 / 小红书 3:4 等 |
| AI 生成封面 | media_gen (Gemini/OpenAI) + reference_images 风格迁移 |
| 首帧合成 | 封面 → 0.1s 视频片段 → ffmpeg concat 到原视频前 |
